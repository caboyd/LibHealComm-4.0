...
if( playerClass == "PRIEST" ) then
	LoadClassData = function()
		...
		if isWrath then
			spellData[Penance] = {_isChanneled = true, coeff = 0.285, ticks = 3, levels = {60, 70, 75, 80}, averages = {avg(670, 756), avg(805, 909), avg(1278, 1442), avg(1484, 1676)}}
		else
			--SOD
			spellData[Penance] = {_isChanneled = true, coeff = 0.285, ticks = 3, levels = generateSODLevels(), averages = generateSODAverages(38.258376, 1.06, 0.904195, 0.161311)}
		end
...
if( playerClass == "SHAMAN" ) then
	LoadClassData = function()
		...
		local SODRunes = {[HealingRain] = true}

		hotData[HealingRain] = {interval = 1, ticks = 10, coeff = 0.063, levels = generateSODLevels(), averages = generateSODAverages(29.888200, 0.15, 0.690312, 0.136267)}
		hotData[Riptide] = {interval = 3, ticks = 5, coeff = 0.188, levels = {60, 70, 75, 80}, averages = {665, 885, 1435, 1670}}
		hotData[Earthliving] = {interval = 3, ticks = 4, coeff = 0.171, levels = {30, 40, 50, 60, 70, 80}, averages = {116, 160, 220, 348, 456, 652}}
...
if( playerClass == "MAGE" ) then
	LoadClassData = function()
		...
		spellData[MassRegeneration] = {_isChanneled = true, coeff = 0.081 * 3, interval = 1,  ticks = 3, levels = generateSODLevels(), averages = generateSODAverages(38.258376, 0.54, 0.904195, 0.161311) }
		spellData[Regeneration] = {_isChanneled = true, coeff = 0.243 * 3 , interval = 1, ticks = 3, levels =  generateSODLevels() , averages = generateSODAverages(38.258376,  1.0, 0.018012, 0.044141)}

		local SODRunes = {[MassRegeneration] = true, [Regeneration] = true}
